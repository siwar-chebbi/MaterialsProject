...
# Geater than 1000###############################################################################
critere4_gte_0 = {"nelements": {'$lte': 6}, "elasticity": {'$ne': None}, "elasticity.G_Reuss": {'$gte': 0},
...
critere4EXP_gte_0 = {"nelements": {'$lte': 6}, "elasticity": {'$ne': None}, 'icsd_ids.0': {'$exists': True},
...
critere4HYP_gte_0 = {"nelements": {'$lte': 6}, "elasticity": {'$ne': None}, 'icsd_ids.0': {'$exists': False},
                        "elasticity.G_Reuss": {'$gte': 0},
                        "elasticity.G_Voigt": {'$gte': 0},
                        "elasticity.G_Voigt_Reuss_Hill": {'$gte': 0},
                        "elasticity.K_Reuss": {'$gte': 0}, "elasticity.K_Voigt": {'$gte': 0},
...
# requete
#materials = api.query(criteria=critere4_gte_0, properties=propsTableauCritere)
...
def export_gte_1000(file_name):
    ...
    extract_data2.to_csv("elastic_property_from_MP_JUL2020_gte_1000.csv")



resultat = recup(materials)
#export(resultat.transpose(), materialIds, propsTableau, "elastic_property_from_MP_JUL2020_critere4_gte_0.csv")
export(resultat.transpose(), materialIds, propsTableau, "elastic_property_from_MP_JUL2020_RatioPoissonNeg.csv")
#export_gte_1000("elastic_property_from_MP_JUL2020_critere4_gte_0.csv")

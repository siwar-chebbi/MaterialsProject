                                ...
                                if not flag_xaxis and not flag_xtwoaxis:
                                    for i, t in enumerate(self._types):
                                        if t in ["tri_plan", "tet"]:
                                            ...
                                            if thetak <= self._paras[i]['TA'] * pi and thetam >= self._paras[i][
                                                'TA'] * pi:
                                                tmp = self._paras[i][
                                                          'IGW_TA'] * (
                                                              thetam * ipi - 0.8)
                                            ...
                                            norms[i][j] += 1
                                                   ...
                                                   "sq_bipyr", "pent_bipyr",
                                                   "hex_bipyr"]:
                                            if thetak < self._paras[i]['min_SPP'] and thetam < self._paras[i][
                                                'min_SPP']:
                                                tmp = cos(
                                                    self._paras[i]['fac_AA'] *
                                                    phi) ** self._paras[i][
                                            ...
                                            if thetam < self._paras[i]['min_SPP'] and thetak > self._paras[i][
                                                4] and thetak < self._paras[i][2]:

...
pdf = matplotlib.backends.backend_pdf.PdfPages("tracage-proprietes-avecPoisson-HYPO.pdf")
...
#
critere4 = {"nelements": {'$lte': 6}, "elasticity": {'$ne': None}, 'icsd_ids.0': {'$exists': False}, "elasticity.G_Reuss": {'$gte': 0, '$lte': 1000},
